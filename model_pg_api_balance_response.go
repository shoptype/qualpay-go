...
type PgApiBalanceResponse struct {
	...
	// <strong>Format: </strong>Variable length, up to 12,2 N<br><strong>Description: </strong>The balance amount available for payments to the FBO merchant account.
