...
type EmbeddedFieldsApiService service
/*
EmbeddedFieldsApiService Get Transient Key
...
*/
func (a *EmbeddedFieldsApiService) GetEmbeddedTransientKey(ctx context.Context) (EmbeddedKeyResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EmbeddedKeyResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/embedded"
