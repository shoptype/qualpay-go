...
**BatchInfo** | **string** | &lt;strong&gt;Format: &lt;/strong&gt;Variable length&lt;br&gt;&lt;strong&gt;Description: &lt;/strong&gt;JSON array of JSON objects containing the batch close results by currency and location. | [optional] [default to null]
